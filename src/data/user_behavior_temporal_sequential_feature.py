...
# 产出：user_active_level.cvs
import pandas as pd
df = pd.read_parquet(
    "taobao-user-behavior-prediction/data/processed/user_features.parquet"
)
...
result.to_csv(
    "taobao-user-behavior-prediction/data/features/user_active_level.csv",
    index=False
)
...
output_path = (
    "taobao-user-behavior-prediction/data/features/time_feature_hourly_weekly.csv"
)
...
result.to_csv(
    "taobao-user-behavior-prediction/data/features/peak_hour_features.csv",
    index=False
)
...
output_path = (
   "taobao-user-behavior-prediction/data/features/user_sequence_features.csv"
)
